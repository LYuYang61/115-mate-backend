...
import com.lyy.utils.AlgorithmUtil;
...
import static com.lyy.constants.UserConstants.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    private static final String[] avatarUrls = {
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/12d4949b4009d089eaf071aef0f1f40.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/1bff61de34bdc7bf40c6278b2848fbcf.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/22fe8428428c93a565e181782e97654.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/75e31415779979ae40c4c0238aa4c34.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/905731909dfdafd0b53b3c4117438d3.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/a84b1306e46061c0d664e6067417e5b.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/b93d640cc856cb7035a851029aec190.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/c11ae3862b3ca45b0a6cdff1e1bf841.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/cccfb0995f5d103414bd8a8bd742c34.jpg",
            "https://qingwu-oss.oss-cn-heyuan.aliyuncs.com/2023/kun/f870176b1a628623fa7fe9918b862d7.jpg"
    };
    @Resource
    ...
    public long userRegister(String phone, String code, String userAccount, String userPassword, String checkPassword) {
        // 1. 校验
        if (StringUtils.isAnyBlank(code, userAccount, userPassword, checkPassword)) {
        ...
        if (correctCode == null) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "请先获取验证码");
        }
    ...
    public Page<User> searchUsersByTags(List<String> tagNameList, long currentPage) {
        ...
        return page(new Page<>(currentPage, SystemConstants.PAGE_SIZE), userLambdaQueryWrapper);
    }
    ...
    public Page<UserVO> userPage(long currentPage) {
        Page<User> page = this.page(new Page<>(currentPage, SystemConstants.PAGE_SIZE));
...
//    }
    ...
    public Page<UserVO> matchUser(long currentPage, User loginUser) {
        ...
        int begin = (int) ((currentPage - 1) * SystemConstants.PAGE_SIZE);
        int end = (int) (((currentPage - 1) * SystemConstants.PAGE_SIZE) + SystemConstants.PAGE_SIZE) - 1;
    ...
    public void updateUserWithCode(UserUpdateRequest updateRequest, Long userId) {
        ...
        if (StringUtils.isNotBlank(updateRequest.getPhone())) {
            key = RedisConstants.USER_UPDATE_PHONE_KEY + updateRequest.getPhone();
            isPhone = true;
        } else {
            key = RedisConstants.USER_UPDATE_EMAIL_KEY + updateRequest.getEmail();
        }
        String correctCode = stringRedisTemplate.opsForValue().get(key);
        if (correctCode == null) {
    ...
    public Page<UserVO> preMatchUser(long currentPage, String username, User loginUser) {
        Gson gson = new Gson();
        if (loginUser != null) {
            String key = RedisConstants.USER_RECOMMEND_KEY + loginUser.getId() + ":" +currentPage;
            if (StringUtils.isNotBlank(username)) {
                LambdaQueryWrapper<User> userLambdaQueryWrapper = new LambdaQueryWrapper<>();
                userLambdaQueryWrapper.like(User::getUsername, username);
                Page<User> userPage = this.page(new Page<>(currentPage, SystemConstants.PAGE_SIZE), userLambdaQueryWrapper);
                Page<UserVO> userVOPage = new Page<>();
            ...
            if (currentPage <= SystemConstants.DEFAULT_CACHE_PAGE) {
                Boolean hasKey = stringRedisTemplate.hasKey(key);
                if (Boolean.TRUE.equals(hasKey)) {
                    String userVOPageStr = stringRedisTemplate.opsForValue().get(key);
                    return gson.fromJson(userVOPageStr, new TypeToken<Page<UserVO>>() {}.getType());
                }else {
    ...
    public String uploadFileAvatar(MultipartFile file, HttpServletRequest request) {
        ...
        stringRedisTemplate.opsForValue().set("user:login:" + loginUser.getId(), userJson);
        return url;
    }
